...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('display_frontend/css/normalize.css') }}">
     <link rel="stylesheet" href="{{ URL::asset('display_frontend/css/swiper.min.css') }}">
    ...
    <script src="{{ URL::asset('display_frontend/js/swiper.jquery.min.js') }}"></script>
    <script src="{{ URL::asset('lib/jquery.number.min.js') }}"></script>
    <script src="{{ URL::asset('display_frontend/js/myscript.js') }}"></script>
                        ...
                        <div class="row">
                            ...
                            <form class="col l5" action="{{ route('search') }}" method="GET" style="" id='form-submit'>
                                ...
                                <div class="search-wrapper card">
                                    <input id="search" name="txtSearch" placeholder="Nhập tên sách, tác giả, cty phát hành" value="{{(isset($txtSearch))?$txtSearch:''}}" style="padding-left: 10px">

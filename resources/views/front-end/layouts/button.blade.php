 ...
 <div class="fixed-action-btn horizontal">
    ...
    <ul>
      @if (Route::current()->getName()=='homepage')
            ...
            <li><a href="{{ route('book.index') }}" class="btn-floating green tooltipped" data-position="top" data-tooltip="Quản lý Sách"><i class="material-icons">library_books</i></a></li>
            ...
            <li><a href="{{ route('author.index') }}" class="btn-floating yellow tooltipped" data-position="top" data-tooltip="Quản lý Tác Giả"><i class="material-icons">supervisor_account</i></a></li>

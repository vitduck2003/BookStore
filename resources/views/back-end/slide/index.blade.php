        ...
        <div ng-controller="MyController" class="my-controller">
          ...
          <b style="color: red">Kéo thả ảnh để thay đổi thứ tự </b>
              <table>
                ...
                <td>
                <img ng-if="slide.slide_image" width="70"  class="responsive-img" ng-src="http://bookstore.vn{{slide.slide_image}}">
                </td>
		            <td>{{slide.link}}</td>
		            <td>
                  <div class="switch">
...
<script src="{{ URL::asset('display_backend/js/jquery-ui.min.js') }}"></script>
  <script src="{{ URL::asset('display_backend/js/sortable-admin.js') }}"></script>
@stop